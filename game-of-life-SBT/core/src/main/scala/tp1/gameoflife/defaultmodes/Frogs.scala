...
class Frogs (override val height: Int, override val width: Int) extends GameEngine {

  override def toString: String = "Frogs"

  override val description: String = "Ribbit, ribbit. " +
    "A cell must be near 1 or 2 cells to stay alive. " +
    "A dead cell revives if there are exactly 3 or 4 cells alive near it. " +
